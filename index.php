...
<body>
            ...
            <div id="content" class="section">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-success mt-3" onclick="generateContentReport()"><i class="fas fa-file-pdf me-2"></i>Generate Report</button>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Platform</th><th>Ad Name</th><th>Results</th>
                                        <th>CPR</th><th>Reach</th><th>Spend</th><th>Date</th><th>Actions</th>
                                    </tr>
                                </thead>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="quotationsTab" role="tabpanel">
                                <div class="table-responsive"><table class="table table-hover"><thead><tr><th>Quote #</th><th>Client</th><th>Type</th><th>Date</th><th>Amount</th><th>Actions</th></tr></thead><tbody id="quotationsTableBody"></tbody></table></div>
                            </div>
                            <div class="tab-pane fade" id="invoicesTab" role="tabpanel">
                                <div class="table-responsive"><table class="table table-hover"><thead><tr><th>Invoice #</th><th>Client</th><th>Type</th><th>Date</th><th>Amount</th><th>Actions</th></tr></thead><tbody id="invoicesTableBody"></tbody></table></div>
                            </div>
                            <div class="tab-pane fade" id="receiptsTab" role="tabpanel">
                                <div class="table-responsive"><table class="table table-hover"><thead><tr><th>Receipt #</th><th>Client</th><th>Type</th><th>Date</th><th>Amount</th><th>Actions</th></tr></thead><tbody id="receiptsTableBody"></tbody></table></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <form id="addCampaignForm">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Evidence URLs (comma-separated)</label>
                                <textarea class="form-control" id="evidenceUrls" rows="2" placeholder="https://example.com/image1.jpg, https://example.com/image2.jpg"></textarea>
                                <small class="text-muted">Add multiple image URLs separated by commas</small>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Upload Evidence Images (Optional)</label>
                                <input type="file" class="form-control" id="evidenceImageUpload" multiple accept="image/*">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h6>Evidence Screenshots/Links</h6>
                            <div id="evidenceContainer" class="mb-3 d-flex flex-wrap"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const permissions = {
            admin: {
                sections: ['dashboard', 'clients', 'content', 'campaigns', 'finances', 'users', 'settings'],
                canAddClient: true,
            ...
            marketer: {
                sections: ['dashboard', 'clients', 'content', 'campaigns'],
                canAddClient: false,
            ...
            finance: {
                sections: ['dashboard', 'clients', 'finances'],
                canAddClient: false,
                canDeleteClient: false,
        ...
        function loadContentCredits() {
            ...
            tbody.innerHTML = contents.map(c => {
                ...
                console.log('Content URL:', c.contentUrl);
        ...
        function viewContent(id) {
            ...
            document.getElementById('viewStartDate').textContent = formatDate(content.startDate);
        ...
        document.getElementById('evidenceImageUpload').addEventListener('change', function(e) {
            ...
            files.forEach(file => {
                ...
                reader.onload = function(event) {
                    ...
                    campaignImageFiles.push(dataUrl);

                    const div = document.createElement('div');
                    div.className = 'evidence-preview';
                    div.innerHTML = `<img src="${dataUrl}" alt="Evidence">`;
        ...
        document.getElementById('addCampaignForm').addEventListener('submit', async function(e) {
            ...
            const evidenceUrls = document.getElementById('evidenceUrls').value
                .split(',')
                .map(url => url.trim())
            ...
            const newCampaignData = {
                ...
                evidenceFiles: [...campaignImageFiles]
            };
        ...
        function viewCampaignDetails(id) {
            ...
            evidenceHTML += (campaign.evidenceUrls || []).map(url => `
                <a href="${url}" target="_blank" class="evidence-preview" style="text-decoration: none; display: flex; align-items: center; justify-content: center; background: #e0e7ff;" title="View Link">
                    <i class="fas fa-link fa-2x text-primary"></i>
                </a>
            `).join('');

            evidenceHTML += (campaign.evidenceFiles || []).map(dataUrl => `
                <div onclick="window.open('${dataUrl}', '_blank')" class="evidence-preview" style="cursor: pointer;" title="Click to enlarge">
                    <img src="${dataUrl}" alt="Evidence">
                </div>
            `).join('');

            evidenceContainer.innerHTML = evidenceHTML || '<p class="text-muted w-100">No evidence provided</p>';
                ...
                <div style="display: flex; min-height: 100vh; font-family: Arial, sans-serif;">
                    ...
                    <div style="width: 30%; background: #2c3e50; color: white; padding: 40px 30px; display: flex; flex-direction: column;">
                        <div style="margin-bottom: 30px;">
                            ${COMPANY_INFO.logoUrl ? `<img src="${COMPANY_INFO.logoUrl}" alt="Logo" style="height: 60px; margin-bottom: 15px; object-fit: contain;">` : ''}
                            <div style="font-size: 28px; font-weight: bold; color: white; margin-bottom: 8px; letter-spacing: 1px;">${COMPANY_INFO.name}</div>
                            <div style="font-size: 14px; color: #bdc3c7; margin-bottom: 40px;">Service beyond expectation</div>
                        </div>
