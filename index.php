...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-primary { background: var(--primary); border: none; padding: 10px 20px; border-radius: 8px; font-weight: 600; transition: all 0.3s; cursor: pointer; color: var(--light); }
            ...
            const reportHtml = `
                <div style="font-family: Arial; padding: 20px;">
                    <div style="display: flex; align-items: center; margin-bottom: 30px; border-bottom: 2px solid #e5e7eb; padding-bottom: 20px;">
                        ${client.logoUrl ? `<img src="${client.logoUrl}" style="width: 32px; height: 32px; object-fit: contain; margin-right: 20px; border-radius: 8px;">` : ''}
                        <div>
                ...
                <div style="display: flex; min-height: 100vh; font-family: Arial, sans-serif;">
                    ...
                    <div style="width: 30%; background: #2c3e50; color: white; padding: 20px 20px; display: flex; flex-direction: column;">
                        <div style="margin-bottom: 15px; text-align: center;">
                            ${COMPANY_INFO.logoUrl ? `<img src="${COMPANY_INFO.logoUrl}" alt="Logo" style="height: 45px; margin-bottom: 5px; object-fit: contain;">` : ''}
