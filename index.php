...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-link:hover { background: rgba(189, 223, 232, 0.4); color: var(--light); transform: translateX(5px); }
    ...
    <script>
        ...
        function viewDocument(type, id) {
           // NOTE: This remains local/front-end for now.
            ...
            const html = `
                <div style="display: flex; font-family: Arial, sans-serif; min-height: 100vh; height: 100vh; align-items: stretch; width: 100%; box-sizing: border-box;">
                    <!-- Sidebar -->
